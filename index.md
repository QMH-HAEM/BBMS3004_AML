...
To run the above steps in a single command, you can run this [shell script](https://github.com/QMH-HAEM/BBMS3004_AML/blob/main/toyPipeline.sh), which contains all the commands above.
